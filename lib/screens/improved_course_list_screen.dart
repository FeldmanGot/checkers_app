...
class ImprovedCourseListScreen extends StatefulWidget {
  ...
  @override
  State<ImprovedCourseListScreen> createState() => _ImprovedCourseListScreenState();
}
...
class _ImprovedCourseListScreenState extends State<ImprovedCourseListScreen> {
  ...
  List<ExtendedCourse> get filteredCourses {
    return courses.where((course) {
      final difficultyMatch = selectedDifficulty == 'all' || course.difficulty == selectedDifficulty;
      final categoryMatch = selectedCategory == 'all' || course.category == selectedCategory;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                spacing: 8,
                children: course.tags.take(3).map((tag) => Container(
                    ...
                    children: [
                      ...
                      Wrap(
                        ...
                        children: [
                          ...
                          _buildDifficultyChip('beginner', 'Новичок', Colors.green),
                          _buildDifficultyChip('intermediate', 'Средний', Colors.orange),
                          _buildDifficultyChip('advanced', 'Продвинутый', Colors.red),
                        ],
                      ),
