...
class _LessonScreenState extends State<LessonScreen> {
  ...
  bool get isCourseCompleted => currentLessonIndex >= widget.course.lessons.length - 1 && isLessonCompleted;
  ...
  void _onUserMove(Pos from, Pos to) {
    ...
    if (userMove.from == expectedConverted.from && userMove.to == expectedConverted.to) {
      // Правильный ход
      correctMoves++;
      setState(() {
      ...
      child: Column(
        ...
        children: [
          ...
          LinearProgressIndicator(
            value: currentLesson.moves.isEmpty ? 0 : currentMoveIndex / currentLesson.moves.length,
          ...
          Expanded(
            child: Container(
              ...
              child: EnhancedCheckersBoard(
                ...
                hintMove: showHint && currentMoveIndex < currentLesson.moves.length 
